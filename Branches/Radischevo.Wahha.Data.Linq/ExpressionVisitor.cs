...
namespace Jeltofiol.Wahha.Data.Linq
{
    public abstract class ExpressionVisitor
    {
        ...
        {
            throw Error.UnknownExpressionType("expression", expression);
        }
        ...
        protected virtual MemberBinding VisitBinding(MemberBinding binding)
        {
            switch (binding.BindingType)
            {
                ...
                default:
                    throw Error.InvalidBindingType("binding", binding);
            }
        }
        ...
        protected UnaryExpression UpdateUnary(UnaryExpression u, Expression operand, 
            Type resultType, MethodInfo method)
        {
        ...
        protected BinaryExpression UpdateBinary(BinaryExpression b, Expression left, 
            Expression right, Expression conversion, bool isLiftedToNull, MethodInfo method)
        {
            if (left != b.Left || right != b.Right || conversion != b.Conversion || 
                method != b.Method || isLiftedToNull != b.IsLiftedToNull)
            {
        ...
        protected TypeBinaryExpression UpdateTypeIs(TypeBinaryExpression b, 
            Expression expression, Type typeOperand)
        {
        ...
        protected ConditionalExpression UpdateConditional(ConditionalExpression c, 
        ...
        protected MemberExpression UpdateMemberAccess(MemberExpression m, 
        ...
        protected MethodCallExpression UpdateMethodCall(MethodCallExpression m, 
            Expression obj, MethodInfo method, IEnumerable<Expression> args)
        {
        ...
        protected MemberAssignment UpdateMemberAssignment(MemberAssignment assignment, 
        ...
        protected MemberMemberBinding UpdateMemberMemberBinding(MemberMemberBinding binding, 
            MemberInfo member, IEnumerable<MemberBinding> bindings)
        {
        ...
        protected MemberListBinding UpdateMemberListBinding(MemberListBinding binding, 
            MemberInfo member, IEnumerable<ElementInit> initializers)
        {
        ...
        protected LambdaExpression UpdateLambda(LambdaExpression lambda, Type delegateType, 
        ...
        protected NewExpression UpdateNew(NewExpression nex, ConstructorInfo constructor, 
        ...
        protected MemberInitExpression UpdateMemberInit(MemberInitExpression init, 
            NewExpression nex, IEnumerable<MemberBinding> bindings)
        {
        ...
        protected ListInitExpression UpdateListInit(ListInitExpression init, 
            NewExpression nex, IEnumerable<ElementInit> initializers)
        {
        ...
        protected NewArrayExpression UpdateNewArray(NewArrayExpression na, 
            Type arrayType, IEnumerable<Expression> expressions)
        {
        ...
        protected InvocationExpression UpdateInvocation(InvocationExpression iv, 
            Expression expression, IEnumerable<Expression> args)
        {
