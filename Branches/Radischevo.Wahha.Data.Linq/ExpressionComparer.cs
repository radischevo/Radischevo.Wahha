...
namespace Jeltofiol.Wahha.Data.Linq
{
    ...
    public class ExpressionComparer
    {
        ...
        private ScopedDictionary<ParameterExpression, ParameterExpression> _scope;
        #endregion
        ...
        protected virtual bool Compare(Expression a, Expression b)
        {
            ...
            switch (a.NodeType)
            {
                ...
                default:
                    throw Error.UnknownExpressionType("a", a);
            }
        }
        ...
        protected virtual bool CompareParameter(ParameterExpression a, ParameterExpression b)
        {
            if (_scope != null)
            {
                ...
                if (_scope.TryGetValue(a, out mapped))
                    return (mapped == b);
            }
            return (a == b);
        }
        ...
        protected virtual bool CompareBinding(MemberBinding a, MemberBinding b)
        {
            ...
            switch (a.BindingType)
            {
                ...
                default:
                    throw Error.InvalidBindingType("a", a);
            }
        }
