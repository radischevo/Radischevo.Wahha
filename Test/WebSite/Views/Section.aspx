<%@ Page Language="C#" Debug="true" EnableViewState="false" ValidateRequest="false" Inherits="Radischevo.Wahha.Web.Mvc.UI.ViewPage" %>
...
<body>
    ...
    <div><h4><%= Url.HostName(1) %>, <%= Parameters.Form.GetValue<bool>("permanent") %></h4>
