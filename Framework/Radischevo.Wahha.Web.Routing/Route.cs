...
namespace Radischevo.Wahha.Web.Routing
{
    ...
    public class Route : RouteBase
	{
        ...
        private string _url;
		private SecureConnectionOption _secureConnection;
		...
		/// </summary>
		public SecureConnectionOption SecureConnection
		{
			get
			{
		...
		private static string DetermineUriScheme(HttpContextBase context, SecureConnectionOption option)
		{
			switch (option)
			{
				case SecureConnectionOption.Always:
				case SecureConnectionOption.Preferred:
					return Uri.UriSchemeHttps;
				case SecureConnectionOption.Never:
		...
		protected virtual bool MatchUriScheme(HttpContextBase context)
		{
			if (SecureConnection == SecureConnectionOption.Always)
